...
unit of margin or a `-N` suffix can be added as a multiplier.  For Snippet
`mar-t-4` to add 4 units of margin to the top of an element.

<Snippet
  file="margin/dir.html"
...
Consider the Snippet below.  The buttons in the left column have equal padding
