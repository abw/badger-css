...
const ColumnExamples = () =>
  <div className="flow">
    ...
    <p className="columns-2 stack-desktop">
      The <code>columns-N</code> class can be added to split text into
      <code>N</code> columns, from 1 to 5.
    </p>

    <h2 className="font-mono">Two Columns</h2>
    <p className="columns-2 stack-desktop">
      The <code>columns-2</code> class splits the text into two columns.
    </p>
    <Example
      html={Two}
      caption="Two Columns"
    ...
    <p className="columns-3 stack-desktop">
      The <code>columns-3</code> class splits the text into two columns.
      And so on...
    </p>
    <Example
      html={Three}
    ...
    <p className="columns-2 stack-desktop">
      ...
      <StackLink text="breakpoint stacking"/> classes (e.g.{' '}
